...
public class MemMusic implements Music {
     ...
     * @param pan
     *            the pan at which to play this MemMusic [-1.0,1.0], values outside the valid range will be ignored
     */
    @Override
    ...
    /**
     * Set the pan of this MemMusic. Must be between -1.0 (full pan left) and 1.0 (full pan right). Values outside the valid range will
     * be ignored.
     * 
     * @param pan
    ...
    /**
     * Unload this MemMusic from the system. Attempts to use this MemMusic after unloading will result in error.
     */
    @Override
    public void unload() {
    ...
    /**
     * The MemMusicReference is an implementation of the MusicReference interface.
     * 
     * @author Finn Kuusisto
     */
	...
	/**
	 * Construct a new MemMusicReference with the given audio data and settings.
	 * 
	 * @param left
	 *            left channel of music data
	 * @param right
	...
	/**
	 * Set the pan of this MemMusicReference. Must be between -1.0 (full pan left) and 1.0 (full pan right).
	 * 
	 * @param pan
	...
	/**
	 * Get the number of bytes remaining for each channel until the end of this MemMusicReference.
	 * 
	 ...
	 * 
	 * @return true if there are no bytes remaining and the reference is no longer playing
	 */
	@Override
	...
	/**
	 * Does any cleanup necessary to dispose of resources in use by this MemMusicReference.
	 */
	@Override

...
public class MemSound implements Sound {
     ...
     *            the volume at which to play this MemSound
     * @param pan
     *            the pan value to play this MemSound [-1.0,1.0], values outside the valid range will assume no panning (0.0)
     */
    @Override
    ...
    /**
     * Stops this MemSound from playing. Note that if this MemSound was played repeatedly in an overlapping fashion, all instances of
     * this MemSound still playing will be stopped.
     */
    @Override
    public void stop() {
    ...
    /**
     * Unloads this MemSound from the system. Attempts to use this MemSound after unloading will result in error.
     */
    @Override
    public void unload() {
	this.mixer.unRegisterSoundReference(this.ID);
    ...
    /**
     * The MemSoundReference is an implementation of the SoundReference interface.
     * 
     * @author Finn Kuusisto
     */
	...
	/**
	 * Does any cleanup necessary to dispose of resources in use by this MemSoundReference.
	 */
	@Override
	public void dispose() {

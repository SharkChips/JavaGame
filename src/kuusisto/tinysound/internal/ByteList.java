...
/**
 * The ByteList class is a dynamically sized array of primitive bytes. This allows the use of a dynamically sized array without the
 * extra overhead that comes with a List of Bytes. ByteList is an internal class of the TinySound system and should be of no real concern to
 * the average user of TinySound.
 * 
...
public class ByteList {
    ...
    /**
     * Create a new ByteList of a specified starting size. If the size is not valid, the default starting size is used.
     * 
     * @param startSize
    ...
    /**
     * Get an array of all the bytes added to this ByteList. This does not affect the backing array.
     * 

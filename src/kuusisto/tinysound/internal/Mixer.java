...
/**
 * The Mixer class is what does the audio data mixing for the TinySound system. Mixer is an internal class of the TinySound system and
...
public class Mixer {
     ...
     * 
     * @param music
     *            MusicReference to be registered
     */
     ...
     * 
     * @param sound
     *            SoundReference to be registered
     */
     ...
     * 
     * @param music
     *            MusicReference to be unregistered
     */
     ...
     * 
     * @param soundID
     *            ID of SoundReferences to be unregistered
     */
     ...
     * @param offset
     *            the start index to read bytes into
     * @param length

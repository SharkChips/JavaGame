...
/**
 * The Music interface is an abstraction for music. Music objects should only be loaded via the TinySound <code>loadMusic()</code>
 * functions. Music can be played, paused, resumed, stopped and looped from specified positions.
 * 
...
public interface Music {
     ...
     *            the volume to play the this Music
     * @param pan
     *            the pan at which to play this Music [-1.0,1.0], values outside the valid range will be ignored
     */
    ...
    /**
     * Set the pan of this Music. Must be between -1.0 (full pan left) and 1.0 (full pan right). Values outside the valid range will be
     * ignored.
     * 
     * @param pan
    ...
    /**
     * Unload this Music from the system. Attempts to use this Music after unloading will result in error.
     */
    public void unload();
}
